...
"use strict";var GetIntrinsic=require(20),$defineProperty=GetIntrinsic("%Object.defineProperty%",!0)||!1;if($defineProperty)try{$defineProperty({} catch (error) {
  console.error(error);
},"a",{value:1})}catch(e){$defineProperty=!1}module.exports=$defineProperty;
...
"use strict";var $defineProperty=require(10),hasPropertyDescriptors=function hasPropertyDescriptors(){return!!$defineProperty};hasPropertyDescriptors.hasArrayLengthDefineBug=function hasArrayLengthDefineBug(){if(!$defineProperty)return null;try{return 1!==$defineProperty([],"length",{value:1} catch (error) {
  console.error(error);
}).length}catch(r){return!0}},module.exports=hasPropertyDescriptors;
