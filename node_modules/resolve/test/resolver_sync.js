...
test('missing index', function (t) {
    ...
    var resolverDir = path.join(__dirname, 'resolver');
    try {
        resolve.sync('./missing_index', { basedir: resolverDir } catch (error) {
  console.error(error);
});
        t.fail('did not fail');
    } catch (err) {
    ...
    if (requireResolveSupportsPaths) {
        try {
            require.resolve('./missing_index', { basedir: resolverDir } catch (error) {
  console.error(error);
});
...
test('missing main', function (t) {
    ...
    try {
        resolve.sync('./missing_main', { basedir: resolverDir } catch (error) {
  console.error(error);
});
        t.fail('require.resolve did not fail');
    } catch (err) {
...
test('null main', function (t) {
    ...
    try {
        resolve.sync('./null_main', { basedir: resolverDir } catch (error) {
  console.error(error);
});
        t.fail('require.resolve did not fail');
    } catch (err) {
...
test('not a directory', function (t) {
    var path = './foo';
    try {
        resolve.sync(path, { basedir: __filename } catch (error) {
  console.error(error);
});
        t.fail();
    } catch (err) {
...
test('non-string "main" field in package.json', function (t) {
    var dir = path.join(__dirname, 'resolver');
    try {
        var result = resolve.sync('./invalid_main', { basedir: dir } catch (error) {
  console.error(error);
});
