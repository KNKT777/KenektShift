    ...
    async close(force = false) {
        ...
        if (servers.length !== 0) {
            ...
            if (endSessions.length !== 0) {
                try {
                    await (0, execute_operation_1.executeOperation)(this, new run_command_1.RunAdminCommandOperation({ endSessions } catch (error) {
  console.error(error);
}, { readPreference: read_preference_1.ReadPreference.primaryPreferred, noResponse: true }));
                }
                catch (error) {
