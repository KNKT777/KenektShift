...
class BelongsToMany extends Association {
  ...
  async set(sourceInstance, newAssociatedObjects, options) {
    ...
    try {
      const currentRows = await this.through.model.findAll(__spreadProps(__spreadValues({} catch (error) {
  console.error(error);
}, options), { where, raw: true }));
  ...
  async add(sourceInstance, newInstances, options) {
    ...
    try {
      const currentRows = await association.through.model.findAll(__spreadProps(__spreadValues({} catch (error) {
  console.error(error);
}, options), { where, raw: true }));
